...
def submit():
	if request.method == 'POST':
		...
		print(yaml)
		os.system('python3 /home/ec2-user/flask3/pipeline2.py start ./uploads/{}'.format(yaml))
		return render_template('upload_success.html')
	elif request.method == 'POST':
		yml = request.form["yaml"]
		print(yml)
		os.system('python3 /home/ec2-user/flask3/pipeline2.py start ./uploads/{}'.format(yml))
		return render_template('upload_success.html')
	else:
		return render_template('upload_failed.html')
